...
<div class="schedule-page container">
    ...
    <div class="schedule-card">
        ...
        <div class="schedule-poster">
            <img src="<?php echo e(asset('images/movies/interstellar.jpg')); ?>" alt="">
        </div>
    ...
    <div class="schedule-card">
        ...
        <div class="schedule-poster">
            <img src="<?php echo e(asset('images/movies/avengersdoomsday.jpg')); ?>" alt="">
        </div>
    ...
    <div class="schedule-card">
        ...
        <div class="schedule-poster">
            <img src="<?php echo e(asset('images/movies/mortalkombat2.jpg')); ?>" alt="">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sabila\aplikasi_ticketing\resources\views/showtimes/index.blade.php ENDPATH**/ ?>