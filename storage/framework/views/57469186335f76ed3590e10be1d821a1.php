...
<div class="promo-page container">
    ...
    <div class="promo-grid">
        ...
        <div class="promo-card">
            <img src="<?php echo e(asset('images/movies/buy1get1.jpg')); ?>" alt="">
        ...
        <div class="promo-card">
            <img src="<?php echo e(asset('images/movies/popcorncombo.jpg')); ?>" alt="">
        ...
        <div class="promo-card">
            <img src="<?php echo e(asset('images/movies/studentsdiscount.jpg')); ?>" alt="">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sabila\aplikasi_ticketing\resources\views/promo/index.blade.php ENDPATH**/ ?>