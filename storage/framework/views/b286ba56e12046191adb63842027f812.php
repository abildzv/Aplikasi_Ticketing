    ...
    <div class="container">
        <div class="nav-wrapper">
            ...
            <div class="menu">
                ...
                <a href="<?php echo e(url('/movies')); ?>">Now Showing</a>
                <a href="<?php echo e(url('/schedule')); ?>">Schedules</a>
                <a href="<?php echo e(url('/promo')); ?>">Promo</a>
            ...
            <div style="display:flex; align-items:center; gap:12px;">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(url('/my-ticket')); ?>">
                    ...
                    <span style="color:#ccc; font-size:13px;">Welcome, <?php echo e(Auth::user()->name); ?></span>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(url('/login')); ?>" class="nav-signin">
...
</script><?php /**PATH C:\Users\Sabila\aplikasi_ticketing\resources\views/layouts/header.blade.php ENDPATH**/ ?>